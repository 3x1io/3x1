...
return [
    ...
    */
    ...
    'repository'   => [
        'provider' => 'github',
        'url'      => 'https://github.com/3x1io/3x1'
    ],
    ...
    */
    ...
    'seo'                 => [
        'author'          => '3x1 Framework',
        'description'     => 'Full Stack Web Framework Build in Laravel & Craftable',
        'keywords'        => 'framework, carftable, laravel, php, settings, media, themes',
        'og'              => [
            'title'       => '3x1 Framework',
            'type'        => 'article',
            'url'         => 'https://framework.3x1.io',
            'image'       => 'https://i.ibb.co/KwQSCyL/1.png',
            'description' => 'Full Stack Web Framework Build in Laravel & Craftable',
        ]
    ],
