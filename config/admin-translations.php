...
return [
    ...
    'scanned_directories' => [
        ...
        base_path('app/Core/brackets/admin-auth/src'),
        base_path('app/Core/brackets/admin-auth/resources'),
        base_path('app/Core/brackets/admin-ui/resources'),
        base_path('app/Core/brackets/admin-translations/resources'),
    ],
