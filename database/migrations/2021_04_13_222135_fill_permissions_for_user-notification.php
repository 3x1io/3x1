...
class FillPermissionsForUserNotification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserNotification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.user-notification.create',
            'admin.user-notification.show',
            'admin.user-notification.edit',
            'admin.user-notification.delete',
            'admin.user-notification.bulk-delete',
        ]);
